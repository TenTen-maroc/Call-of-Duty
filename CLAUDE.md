...
| Quality gates | ✅ `node Tools/typecheck.mjs` (9 assemblies, tests included) + `node Tools/check.mjs` + **127 tests** + `node Tools/verify-build.mjs` |
...
runs under test: 127 tests across both suites drive the real loop and the real
