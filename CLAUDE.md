...
| Quality gates | ✅ `node Tools/typecheck.mjs` (7 assemblies) + `node Tools/check.mjs` + **62 tests** + `node Tools/verify-build.mjs` |
...
runs under test: 62 tests across both suites drive the real loop and the real
