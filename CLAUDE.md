...
| Quality gates | ✅ `node Tools/typecheck.mjs` (9 assemblies, tests included) + `node Tools/check.mjs` + **232 tests** + `node Tools/verify-build.mjs` + `node Tools/screenshot.mjs` |
