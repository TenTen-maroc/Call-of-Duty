...
| Quality gates | ✅ `node Tools/typecheck.mjs` (9 assemblies, tests included) + `node Tools/check.mjs` + **108 tests** + `node Tools/verify-build.mjs` |
...
runs under test: 108 tests across both suites drive the real loop and the real
